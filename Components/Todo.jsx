...
const Todo = ({id,title,description,mongoId,complete,deleteTodo,completeTodo,undoTodo}) => {
    return (
            ...
            <tr className="bg-white border-b">
                ...
                <td className="px-6 py-4 flex gap-1">
                    ...
                    {complete
                    ? <button onClick={() => undoTodo(mongoId)} className='py-2 px-4 bg-yellow-500 text-white'>Undo</button>
